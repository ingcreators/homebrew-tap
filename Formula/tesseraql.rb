...
class Tesseraql < Formula
  ...
  url "https://github.com/ingcreators/tesseraql/releases/download/v0.7.0/tesseraql-cli-0.7.0-dist.tar.gz"
  sha256 "bd2f643c779b97891f97d8dd15f9bd3ccefaf64db0b0e3cf2788828e898a29f0"
  license "Apache-2.0"
