...
class Tesseraql < Formula
  ...
  url "https://github.com/ingcreators/tesseraql/releases/download/v0.6.0/tesseraql-cli-0.6.0-dist.tar.gz"
  sha256 "4f3737834711a1665279d2db77712a93195978743b7c1c7811778ee0f1b7605b"
  license "Apache-2.0"
